...
- **Sistema de puntuación**: Soporte para sistemas clásico, simple o totalmente personalizado.
...
- **Registro rápido**: Introduce rápidamente la clasificación de cada carrera.
